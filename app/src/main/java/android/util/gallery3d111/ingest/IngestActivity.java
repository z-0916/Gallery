...
package android.util.gallery3d111.ingest;

import com.android.gallery3d111.R;
import android.util.gallery3d111.ingest.adapter.CheckBroker;
import android.util.gallery3d111.ingest.adapter.MtpAdapter;
import android.util.gallery3d111.ingest.adapter.MtpPagerAdapter;
import android.util.gallery3d111.ingest.data.ImportTask;
import android.util.gallery3d111.ingest.data.IngestObjectInfo;
import android.util.gallery3d111.ingest.data.MtpBitmapFetch;
import android.util.gallery3d111.ingest.data.MtpDeviceIndex;
import android.util.gallery3d111.ingest.ui.DateTileView;
import android.util.gallery3d111.ingest.ui.IngestGridView;
...
public class IngestActivity extends Activity implements
  ...
  private class PositionMappingCheckBroker extends CheckBroker
      implements IngestGridView.OnClearChoicesListener {
