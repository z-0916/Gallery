...
package android.util.gallery3d111.ingest.data;
...
public class MtpClient {
  ...
  /**
   * Registers a {@link android.util.gallery3d111.data.MtpClient.Listener} interface to receive
  ...
  /**
   * Unregisters a {@link android.util.gallery3d111.data.MtpClient.Listener} interface.
   *
