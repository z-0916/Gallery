...
package android.util.gallery3d111.filtershow;
...
import android.util.gallery3d111.app.CheckPermissionActivity;
import android.util.gallery3d111.app.PhotoPage;
import android.util.gallery3d111.data.LocalAlbum;
import android.util.gallery3d111.filtershow.cache.ImageLoader;
import android.util.gallery3d111.filtershow.category.Action;
import android.util.gallery3d111.filtershow.category.CategoryAdapter;
import android.util.gallery3d111.filtershow.category.CategorySelected;
import android.util.gallery3d111.filtershow.category.CategoryView;
import android.util.gallery3d111.filtershow.category.MainPanel;
import android.util.gallery3d111.filtershow.category.SwipableView;
import android.util.gallery3d111.filtershow.data.UserPresetsManager;
import android.util.gallery3d111.filtershow.editors.BasicEditor;
import android.util.gallery3d111.filtershow.editors.Editor;
import android.util.gallery3d111.filtershow.editors.EditorChanSat;
import android.util.gallery3d111.filtershow.editors.EditorColorBorder;
import android.util.gallery3d111.filtershow.editors.EditorCrop;
import android.util.gallery3d111.filtershow.editors.EditorDraw;
import android.util.gallery3d111.filtershow.editors.EditorGrad;
import android.util.gallery3d111.filtershow.editors.EditorManager;
import android.util.gallery3d111.filtershow.editors.EditorMirror;
import android.util.gallery3d111.filtershow.editors.EditorPanel;
import android.util.gallery3d111.filtershow.editors.EditorRedEye;
import android.util.gallery3d111.filtershow.editors.EditorRotate;
import android.util.gallery3d111.filtershow.editors.EditorStraighten;
import android.util.gallery3d111.filtershow.editors.EditorTinyPlanet;
import android.util.gallery3d111.filtershow.editors.ImageOnlyEditor;
import android.util.gallery3d111.filtershow.filters.FilterDrawRepresentation;
...
import android.util.gallery3d111.filtershow.filters.FilterRotateRepresentation;
import android.util.gallery3d111.filtershow.filters.FilterUserPresetRepresentation;
import android.util.gallery3d111.filtershow.filters.FiltersManager;
import android.util.gallery3d111.filtershow.filters.ImageFilter;
import android.util.gallery3d111.filtershow.history.HistoryItem;
import android.util.gallery3d111.filtershow.history.HistoryManager;
import android.util.gallery3d111.filtershow.imageshow.ImageShow;
import android.util.gallery3d111.filtershow.imageshow.MasterImage;
import android.util.gallery3d111.filtershow.imageshow.Spline;
import android.util.gallery3d111.filtershow.info.InfoPanel;
import android.util.gallery3d111.filtershow.pipeline.CachingPipeline;
import android.util.gallery3d111.filtershow.pipeline.ImagePreset;
import android.util.gallery3d111.filtershow.pipeline.ProcessingService;
import android.util.gallery3d111.filtershow.presets.PresetManagementDialog;
import android.util.gallery3d111.filtershow.presets.UserPresetsAdapter;
import android.util.gallery3d111.filtershow.provider.SharedImageProvider;
import android.util.gallery3d111.filtershow.state.StateAdapter;
import android.util.gallery3d111.filtershow.tools.SaveImage;
import android.util.gallery3d111.filtershow.tools.XmpPresets;
import android.util.gallery3d111.filtershow.ui.ExportDialog;
import android.util.gallery3d111.filtershow.ui.FramedTextButton;
...
public class FilterShowActivity extends FragmentActivity implements OnItemClickListener,
    ...
    private void extractXMPData() {
        XmpPresets.XMresults res = XmpPresets.extractXMPData(
