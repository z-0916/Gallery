...
package android.util.gallery3d111.filtershow.editors;

import android.content.Context;
import android.content.res.Configuration;
import android.util.Log;
import android.util.gallery3d111.filtershow.controller.ActionSlider;
import android.util.gallery3d111.filtershow.controller.BasicSlider;
import android.util.gallery3d111.filtershow.controller.ColorChooser;
import android.util.gallery3d111.filtershow.controller.Control;
import android.util.gallery3d111.filtershow.controller.Parameter;
import android.util.gallery3d111.filtershow.controller.ParameterActionAndInt;
import android.util.gallery3d111.filtershow.controller.ParameterBrightness;
import android.util.gallery3d111.filtershow.controller.ParameterColor;
import android.util.gallery3d111.filtershow.controller.ParameterHue;
import android.util.gallery3d111.filtershow.controller.ParameterInteger;
import android.util.gallery3d111.filtershow.controller.ParameterOpacity;
import android.util.gallery3d111.filtershow.controller.ParameterSaturation;
import android.util.gallery3d111.filtershow.controller.ParameterStyles;
import android.util.gallery3d111.filtershow.controller.SliderBrightness;
import android.util.gallery3d111.filtershow.controller.SliderHue;
import android.util.gallery3d111.filtershow.controller.SliderOpacity;
import android.util.gallery3d111.filtershow.controller.SliderSaturation;
import android.util.gallery3d111.filtershow.controller.StyleChooser;
import android.util.gallery3d111.filtershow.controller.TitledSlider;
import android.util.gallery3d111.filtershow.filters.FilterBasicRepresentation;
