...
import android.util.gallery3d111.exif.ExifTag;

import android.util.gallery3d111.filtershow.FilterShowActivity;
import android.util.gallery3d111.filtershow.cache.BitmapCache;
...
import android.util.gallery3d111.filtershow.pipeline.Buffer;
import android.util.gallery3d111.filtershow.pipeline.ImagePreset;
import android.util.gallery3d111.filtershow.pipeline.RenderingRequest;
import android.util.gallery3d111.filtershow.pipeline.RenderingRequestCaller;
import android.util.gallery3d111.filtershow.pipeline.SharedBuffer;
import android.util.gallery3d111.filtershow.pipeline.SharedPreset;
