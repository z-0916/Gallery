...
import android.util.gallery3d111.app.FilterUtils;
import android.util.gallery3d111.app.GalleryApp;
import android.util.gallery3d111.app.StitchingChangeListener;
...
public class DataManager implements StitchingChangeListener {
    public static final  int INCLUDE_AII_TIME=4;
    ...
    private static final String TOP_SET_PATH_TIME = "/cluster/{/combo/{/local/all,/picasa/all}}/time";
//    private static final String TOP_SET_PATH_TIME = FilterUtils.switchClusterPath(TOP_SET_PATH,FilterUtils.CLUSTER_BY_TIME);
//    private static final String TOP_SET_PATH_TIME=FilterUtils.newClusterPath(TOP_SET_PATH,FilterUtils.CLUSTER_BY_TIME);
    ...
    public String getTopSetPathTime(int typeBits) {

        switch (typeBits) {
            case INCLUDE_AII_TIME:return TOP_SET_PATH_TIME;
            default: throw new IllegalArgumentException();
        }
    }
