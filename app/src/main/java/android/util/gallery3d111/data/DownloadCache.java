...
import android.util.gallery3d111.app.GalleryApp;
import android.util.gallery3d111.common.LruCache;
...
import android.util.gallery3d111.util.ThreadPool.CancelListener;
import android.util.gallery3d111.util.ThreadPool.Job;
import android.util.gallery3d111.util.ThreadPool.JobContext;
...
public class DownloadCache {
    ...
    private static final String QUERY_PROJECTION[] = {DownloadEntry.Columns.ID, DownloadEntry.Columns.DATA};
    private static final String WHERE_HASH_AND_URL = String.format(
            "%s = ? AND %s = ?", DownloadEntry.Columns.HASH_CODE, DownloadEntry.Columns.CONTENT_URL);
    ...
    private static final String FREESPACE_PROJECTION[] = {
            DownloadEntry.Columns.ID, DownloadEntry.Columns.DATA, DownloadEntry.Columns.CONTENT_URL, DownloadEntry.Columns.CONTENT_SIZE};
    private static final String FREESPACE_ORDER_BY =
            String.format("%s ASC", DownloadEntry.Columns.LAST_ACCESS);
    ...
    private static final String ID_WHERE = DownloadEntry.Columns.ID + " = ?";

    private static final String SUM_PROJECTION[] =
            {String.format("sum(%s)", DownloadEntry.Columns.CONTENT_SIZE)};
    ...
    private void updateLastAccess(long id) {
        ...
        values.put(DownloadEntry.Columns.LAST_ACCESS, System.currentTimeMillis());
    ...
    private synchronized long insertEntry(String url, File file) {
        ...
        values.put(DownloadEntry.Columns.DATA, file.getAbsolutePath());
        values.put(DownloadEntry.Columns.HASH_CODE, hashCode);
        values.put(DownloadEntry.Columns.CONTENT_URL, url);
        values.put(DownloadEntry.Columns.CONTENT_SIZE, size);
        values.put(DownloadEntry.Columns.LAST_UPDATED, System.currentTimeMillis());
