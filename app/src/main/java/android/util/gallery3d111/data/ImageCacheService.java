...
import android.util.gallery3d111.common.BlobCache;
import android.util.gallery3d111.common.BlobCache.LookupRequest;
import android.util.gallery3d111.common.Utils;
import android.util.gallery3d111.util.CacheManager;
...
public class ImageCacheService {
     ...
     */
    public boolean getImageData(Path path,String filePath, long timeModified, int type, BytesBufferPool.BytesBuffer buffer) {
