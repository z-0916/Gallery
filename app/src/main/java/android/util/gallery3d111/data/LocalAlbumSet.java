...
import android.util.gallery3d111.data.BucketHelper.BucketEntry;
...
//        run 方法执行完成后，执行mListener.onFutureDone回调接口
        @Override
...
//该方法最终走到AlbumSetDataLoader的onContentDirty方法
    @Override
