...
import android.util.gallery3d111.app.PanoramaMetadataSupport;
import android.util.gallery3d111.common.ApiHelper;
import android.util.gallery3d111.common.BitmapUtils;
import android.util.gallery3d111.exif.ExifInterface;
...
import android.util.gallery3d111.util.UpdateHelper;
    ...
    public class LocalImageRequest extends ImageCacheRequest {
        ...
        public Bitmap onDecodeOriginal(JobContext jc, final int type) {
            if(type == MediaItem.TYPE_DECODE){
                  return new android.util.gallery3d111.util.BitmapUtils(mApplication.getAndroidContext())
    ...
    private class BitmapJob implements Job<BitmapInfo> {
        ...
        public BitmapInfo run(JobContext jc) {
            return new BitmapInfo(mUri,
                    new android.util.gallery3d111.util.BitmapUtils(mApplication.getAndroidContext()).getNotRotateBitmap(mUri, 1024, 768));
        }
    }
}
