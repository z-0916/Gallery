...
import android.util.gallery3d111.data.ComboAlbum;
import android.util.gallery3d111.data.DataManager;
import android.util.gallery3d111.data.FilterSource;
...
import android.util.gallery3d111.data.SecureAlbum;
import android.util.gallery3d111.data.SecureSource;
import android.util.gallery3d111.data.SnailAlbum;
import android.util.gallery3d111.data.SnailItem;
import android.util.gallery3d111.data.SnailSource;
...
import android.util.gallery3d111.data.FilterDeleteSet;
...
import android.util.gallery3d111.ui.DetailsHelper.DetailsSource;
import android.util.gallery3d111.ui.GLRootView;
import android.util.gallery3d111.ui.GLView;
import android.util.gallery3d111.ui.MenuExecutor;
import android.util.gallery3d111.ui.PhotoView;
...
import android.util.gallery3d111.util.UsageStatistics;
        ...
        try{
            if (oldUri.toString().startsWith("file:///storage")) {
                Uri uri = FileProvider.getUriForFile(context,
                        "com.android.gallery3d111.fileprovider",
