...
import android.util.gallery3d111.anim.CanvasAnimation;
import android.util.gallery3d111.util.GalleryUtils;
import android.util.gallery3d111.util.MotionEventHelper;
import android.util.gallery3d111.util.Profile;
...
import android.util.gallery3d111.glrenderer.GLES11Canvas;
import android.util.gallery3d111.glrenderer.GLES20Canvas;
...
//    每一帧绘制时被调用
    ...
    private void onDrawFrameLocked(GL10 gl) {
        ...
        if (DEBUG_INVALIDATE) {
            mCanvas.fillRect(10, 10, 10, 10, mInvalidateColor);
